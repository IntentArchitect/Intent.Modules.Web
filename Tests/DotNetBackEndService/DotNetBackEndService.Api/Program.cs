using DotNetBackEndService.Api.Configuration;
using DotNetBackEndService.Api.Filters;
using DotNetBackEndService.Api.Logging;
using DotNetBackEndService.Application;
using DotNetBackEndService.Infrastructure;
...
namespace DotNetBackEndService.Api
{
