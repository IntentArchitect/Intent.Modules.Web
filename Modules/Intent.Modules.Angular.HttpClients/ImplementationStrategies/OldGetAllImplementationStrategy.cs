...
public class OldGetAllImplementationStrategy //: BaseImplementationStrategy, IImplementationStrategy
{
    //public OldGetAllImplementationStrategy(IApplication application, IAssociation association)
    //{
    ...
    //    return endpoint.Verb == Metadata.WebApi.Models.HttpVerb.Get && endpoint.ReturnType.IsCollection && endpoint.Inputs.Count == 0;
    //}
    ...
    //    // TODO: this check to see if a proper mapping is required. This can go around the about templateOperation.AddStatement call
    //    //if (serviceOperation.ReturnType.ElementId == targetModel.TypeReference.ElementId)
    //}
}
