...
public class GetAllImplementationStrategy : BaseImplementationStrategy, IImplementationStrategy
{
    public GetAllImplementationStrategy(IApplication application, IAssociation association)
    {
