...
public static class SecuredHelper
{
    ...
    //public static IHtmlElement AuthorizeComponent(this IHtmlElement htmlElement, IElement element, ITypescriptComponentTemplate template)
    //{
    ...
    //public static void AuthorizeComponent(ITypescriptComponentTemplate template, IElement component, IEnumerable<IRazorFileNode> razorNodes, IRazorFileNode node)
    //{
    //    // no secured stereotype
