...
namespace Intent.Modules.Angular.Templates.AI.LayoutShellSkill
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class LayoutShellSkillTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Angular.AI.LayoutShellSkillTemplate";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public LayoutShellSkillTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile($"SKILL", "md", "angular-layout-application-shell")
                .FromMarkdown($$"""
---
