...
namespace Intent.Modules.Angular.Templates.AI.GeneralAngularComponentInstructions
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class GeneralAngularComponentInstructionsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Angular.AI.GeneralAngularComponentInstructionsTemplate";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public GeneralAngularComponentInstructionsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile($"angular-component-general.instructions")
                .FromMarkdown($$"""
---
