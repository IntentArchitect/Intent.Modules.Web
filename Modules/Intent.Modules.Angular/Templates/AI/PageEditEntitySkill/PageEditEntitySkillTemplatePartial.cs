...
namespace Intent.Modules.Angular.Templates.AI.PageEditEntitySkill
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class PageEditEntitySkillTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Angular.AI.PageEditEntitySkillTemplate";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public PageEditEntitySkillTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile($"SKILL", "md", "angular-page-editing-entity")
                .FromMarkdown($$"""
---
