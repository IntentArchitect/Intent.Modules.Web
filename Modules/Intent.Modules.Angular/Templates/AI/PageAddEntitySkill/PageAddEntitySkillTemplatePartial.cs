...
namespace Intent.Modules.Angular.Templates.AI.PageAddEntitySkill
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class PageAddEntitySkillTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Angular.AI.PageAddEntitySkillTemplate";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public PageAddEntitySkillTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile($"SKILL", "md", "angular-page-adding-entity")
                .FromMarkdown($$"""
---
