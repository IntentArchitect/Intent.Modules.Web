...
namespace Intent.Modules.Angular.Templates.AI.DialogAddEntitySkill
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class DialogAddEntitySkillTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Angular.AI.DialogAddEntitySkillTemplate";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public DialogAddEntitySkillTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile($"SKILL", "md", "angular-dialog-adding-entity")
                .FromMarkdown($$"""
---
...
3. `add-entity-dialog-sample.scss`
