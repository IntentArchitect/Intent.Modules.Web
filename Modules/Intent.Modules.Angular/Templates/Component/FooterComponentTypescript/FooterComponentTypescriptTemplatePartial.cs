...
namespace Intent.Modules.Angular.Templates.Component.FooterComponentTypescript
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public partial class FooterComponentTypescriptTemplate : TypeScriptTemplateBase<Intent.Modelers.UI.Api.LayoutFooterModel>, ITypescriptFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Angular.Component.FooterComponentTypescript";

        [IntentManaged(Mode.Ignore, Signature = Mode.Fully)]
        public FooterComponentTypescriptTemplate(IOutputTarget outputTarget,
            Intent.Modelers.UI.Api.LayoutFooterModel model) : base(TemplateId, outputTarget, model)
        {
