...
namespace Intent.Modules.Angular.Templates.Component.FooterComponentStyle
{
    ...
    public class FooterComponentStyleTemplateRegistration : FilePerModelTemplateRegistration<LayoutFooterModel>
    {
        private readonly IMetadataManager _metadataManager;

        public FooterComponentStyleTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => FooterComponentStyleTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, LayoutFooterModel model)
        {
            return new FooterComponentStyleTemplate(outputTarget, model);
        }
