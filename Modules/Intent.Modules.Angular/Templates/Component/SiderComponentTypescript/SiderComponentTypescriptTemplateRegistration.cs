...
namespace Intent.Modules.Angular.Templates.Component.SiderComponentTypescript
{
    ...
    public class SiderComponentTypescriptTemplateRegistration : FilePerModelTemplateRegistration<LayoutSiderModel>
    {
        private readonly IMetadataManager _metadataManager;

        public SiderComponentTypescriptTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => SiderComponentTypescriptTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, LayoutSiderModel model)
        {
            return new SiderComponentTypescriptTemplate(outputTarget, model);
        }
