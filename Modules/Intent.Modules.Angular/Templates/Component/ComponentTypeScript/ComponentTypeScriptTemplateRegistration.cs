...
namespace Intent.Modules.Angular.Templates.Component.ComponentTypeScript
{
    ...
    public class ComponentTypeScriptTemplateRegistration : FilePerModelTemplateRegistration<ComponentModel>
    {
        private readonly IMetadataManager _metadataManager;

        public ComponentTypeScriptTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => ComponentTypeScriptTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, ComponentModel model)
        {
            return new ComponentTypeScriptTemplate(outputTarget, model);
        }
