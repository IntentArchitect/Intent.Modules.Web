...
namespace Intent.Modules.Angular.Templates.Component.HeaderComponentTypescript
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public partial class HeaderComponentTypescriptTemplate : TypeScriptTemplateBase<Intent.Modelers.UI.Api.LayoutHeaderModel>, ITypescriptFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Angular.Component.HeaderComponentTypescript";

        [IntentManaged(Mode.Ignore, Signature = Mode.Fully)]
        public HeaderComponentTypescriptTemplate(IOutputTarget outputTarget,
            Intent.Modelers.UI.Api.LayoutHeaderModel model) : base(TemplateId, outputTarget, model)
        {
