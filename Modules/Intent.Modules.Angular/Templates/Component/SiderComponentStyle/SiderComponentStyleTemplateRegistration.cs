...
namespace Intent.Modules.Angular.Templates.Component.SiderComponentStyle
{
    ...
    public class SiderComponentStyleTemplateRegistration : FilePerModelTemplateRegistration<LayoutSiderModel>
    {
        private readonly IMetadataManager _metadataManager;

        public SiderComponentStyleTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => SiderComponentStyleTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, LayoutSiderModel model)
        {
            return new SiderComponentStyleTemplate(outputTarget, model);
        }
