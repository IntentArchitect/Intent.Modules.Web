...
internal class ServeBuilderDevKitPatch : IAngularJsonPatch
{
    private readonly string _applicationName;

    public ServeBuilderDevKitPatch(AngularSettings.AngularVersionOptionsEnum angularVersion, string applicationName)
    {
    ...
    public void Apply(IDataFile file)
    {
        ...
        {
            serveObject.WithValue("builder", "@angular-devkit/build-angular:dev-server", 0);
            return;
        }

        var builderProperty = serveObject["builder"] as IDataFileScalarValue;
        builderProperty.Value = "@angular-devkit/build-angular:dev-server";
    }
}
